...
# Misc package images (in /images folder)
	$_PIMG_PREFIX						= '<img src="'.PKG_URL_IMGS;
...
$_TCFG['_IMG_BACK_TO_BILL_M']		= $_PARM_PREFIX.'n_med_back_to_bill.gif'.'" alt="'.$_LANG['_THEME']['ALT_IMG_BACK_TO_BILL_M'].$_PARM_SUFFIX;				// Image URL for: Back To Bill Button (medium)
$_TCFG['_IMG_BACK_TO_BILL_M_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_med_back_to_bill.gif';
$_TCFG['_IMG_BITEMS_EDITOR_M']	= $_PARM_PREFIX.'n_med_bitems_editor.gif'.'" alt="'.$_LANG['_THEME']['ALT_IMG_BITEMS_EDITOR_M'].$_PARM_SUFFIX;				// Image URL for: Bill Items Editor Button (medium)
$_TCFG['_IMG_BITEMS_EDITOR_M_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_med_bitems_editor.gif';				// Image URL for: Bill Items Editor Button (medium)
$_TCFG['_IMG_BILL_TRANS_M']		= $_PARM_PREFIX.'n_med_bill_trans.gif'.'" alt="'.$_LANG['_THEME']['ALT_IMG_BILL_TRANS_M'].$_PARM_SUFFIX;					// Image URL for: Bill Transactions Button (medium)
$_TCFG['_IMG_BILL_TRANS_M_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_med_bill_trans.gif';					// Image URL for: Bill Transactions Button (medium)
$_TCFG['_IMG_BACK_TO_SUPPLIER_M']	= $_PARM_PREFIX.'n_med_back_to_supplier.gif'.'" alt="'.$_LANG['_THEME']['ALT_IMG_BACK_TO_SUPPLIER_M'].$_PARM_SUFFIX;			// Image URL for: Back To Supplier Button (medium)
$_TCFG['_IMG_BACK_TO_SUPPLIER_M_MO']	= $_CCFG['_PKG_URL_THEME_IMGS'].'nav/'.'n_med_back_to_supplier.gif';			// Image URL for: Back To Supplier Button (medium)
...
# Buttons / Img File URLS (smallest ones- 25 px high)
	$_TCFG['_IMG_BLANK_S']			= $_PARM_PREFIX.'n_spacer.gif'.'" width="24" height="0" alt="'.$_LANG['_THEME']['ALT_IMG_BLANK_S'].$_PARM_SUFFIX;								// Image URL for: Blank Button (small)
